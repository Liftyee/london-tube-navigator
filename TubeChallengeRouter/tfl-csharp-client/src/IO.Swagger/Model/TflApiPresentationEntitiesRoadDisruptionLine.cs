...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TflApiPresentationEntitiesRoadDisruptionLine :  IEquatable<TflApiPresentationEntitiesRoadDisruptionLine>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TflApiPresentationEntitiesRoadDisruptionLine" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="roadDisruptionId">roadDisruptionId.</param>
        /// <param name="isDiversion">isDiversion.</param>
        /// <param name="multiLineString">multiLineString.</param>
        /// <param name="startDate">startDate.</param>
        /// <param name="endDate">endDate.</param>
        /// <param name="startTime">startTime.</param>
        /// <param name="endTime">endTime.</param>
        public TflApiPresentationEntitiesRoadDisruptionLine(int? id = default(int?), string roadDisruptionId = default(string), bool? isDiversion = default(bool?), SystemDataSpatialDbGeography multiLineString = default(SystemDataSpatialDbGeography), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), string startTime = default(string), string endTime = default(string))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as TflApiPresentationEntitiesRoadDisruptionLine);
        }

        /// <summary>
        /// Returns true if TflApiPresentationEntitiesRoadDisruptionLine instances are equal
        /// </summary>
        /// <param name="input">Instance of TflApiPresentationEntitiesRoadDisruptionLine to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TflApiPresentationEntitiesRoadDisruptionLine input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.IsDiversion == input.IsDiversion ||
                    (this.IsDiversion != null &&
                    this.IsDiversion.Equals(input.IsDiversion))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsDiversion != null)
                    hashCode = hashCode * 59 + this.IsDiversion.GetHashCode();
